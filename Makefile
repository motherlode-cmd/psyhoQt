#############################################################################
# Makefile for building: aviasales.app/Contents/MacOS/aviasales
# Generated by qmake (3.1) (Qt 6.7.2)
# Project:  aviasales.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile aviasales.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = aviasales1.0.0
DISTDIR = /Users/oksanafedorova/Downloads/Telegram\ Desktop/aviasales/.tmp/aviasales1.0.0
...
SOURCES       = Flight/Flight.cpp \
		...
		main.cpp \
		mainwindow.cpp moc_formflight.cpp \
		moc_QTableModel.cpp \
		moc_avltreemodel.cpp \
		moc_formpassanger.cpp \
		moc_formsales.cpp \
		moc_hashtablemodel.cpp \
		moc_listmodel.cpp \
		moc_mainwindow.cpp
OBJECTS       = Flight.o \
		formflight.o \
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		aviasales.pro Flight/Flight.hpp \
		...
		Models/listmodel.h \
		mainwindow.h Flight/Flight.cpp \
		FormFlight/formflight.cpp \
		HashTable/HashTable.cpp \
		List/List.cpp \
		Passenger/Passenger.cpp \
		...
		main.cpp \
		mainwindow.cpp
QMAKE_TARGET  = aviasales
DESTDIR       = 
TARGET        = aviasales.app/Contents/MacOS/aviasales
...
EXPORT__PRO_FILE_ = /Users/oksanafedorova/Downloads/Telegram Desktop/aviasales/aviasales.pro
...
aviasales.app/Contents/MacOS/aviasales: ui_formflight.h ui_formpassanger.h ui_formsales.h ui_mainwindow.h $(OBJECTS)  
	@test -d aviasales.app/Contents/MacOS/ || mkdir -p aviasales.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: aviasales.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.7.2_2/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.7.2_2/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.7.2_2/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile aviasales.pro
...
aviasales.app/Contents/PkgInfo: 
	@test -d aviasales.app/Contents || mkdir -p aviasales.app/Contents
	@$(DEL_FILE) aviasales.app/Contents/PkgInfo
	@echo "APPL????" > aviasales.app/Contents/PkgInfo
aviasales.app/Contents/Info.plist: 
	@test -d aviasales.app/Contents || mkdir -p aviasales.app/Contents
	@$(DEL_FILE) aviasales.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,com.yourcompany.aviasales,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},com.yourcompany.aviasales,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,aviasales,g" -e "s,@LIBRARY@,aviasales,g" -e "s,\$${EXECUTABLE_NAME},aviasales,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >aviasales.app/Contents/Info.plist

all: Makefile \
		aviasales.app/Contents/PkgInfo \
		aviasales.app/Contents/Info.plist aviasales.app/Contents/MacOS/aviasales
...
distdir: FORCE
	...
	$(COPY_FILE) --parents Flight/Flight.hpp FormFlight/formflight.h HashTable/HashTable.hpp List/List.hpp Passenger/Passenger.hpp Sales/Sales.hpp Tree/AVLTree.hpp Models/QTableModel.h Models/avltreemodel.h FormPassanger/formpassanger.h FormSales/formsales.h Models/hashtablemodel.h Models/listmodel.h mainwindow.h $(DISTDIR)/
	$(COPY_FILE) --parents Flight/Flight.cpp FormFlight/formflight.cpp HashTable/HashTable.cpp List/List.cpp Passenger/Passenger.cpp Sales/Sales.cpp Tree/AVLTree.cpp Models/QTableModel.cpp Models/avltreemodel.cpp FormPassanger/formpassanger.cpp FormSales/formsales.cpp Models/hashtablemodel.cpp Models/listmodel.cpp main.cpp mainwindow.cpp $(DISTDIR)/
	$(COPY_FILE) --parents FormFlight/formflight.ui FormPassanger/formpassanger.ui FormSales/formsales.ui mainwindow.ui $(DISTDIR)/
...
compiler_moc_header_make_all: moc_formflight.cpp moc_QTableModel.cpp moc_avltreemodel.cpp moc_formpassanger.cpp moc_formsales.cpp moc_hashtablemodel.cpp moc_listmodel.cpp moc_mainwindow.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_formflight.cpp moc_QTableModel.cpp moc_avltreemodel.cpp moc_formpassanger.cpp moc_formsales.cpp moc_hashtablemodel.cpp moc_listmodel.cpp moc_mainwindow.cpp
moc_formflight.cpp: FormFlight/formflight.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include '/Users/oksanafedorova/Downloads/Telegram Desktop/aviasales/moc_predefs.h' -I/opt/homebrew/share/qt/mkspecs/macx-clang -I'/Users/oksanafedorova/Downloads/Telegram Desktop/aviasales' -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib FormFlight/formflight.h -o moc_formflight.cpp

moc_QTableModel.cpp: Models/QTableModel.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include '/Users/oksanafedorova/Downloads/Telegram Desktop/aviasales/moc_predefs.h' -I/opt/homebrew/share/qt/mkspecs/macx-clang -I'/Users/oksanafedorova/Downloads/Telegram Desktop/aviasales' -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib Models/QTableModel.h -o moc_QTableModel.cpp

moc_avltreemodel.cpp: Models/avltreemodel.h \
		Models/QTableModel.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QAbstractListModel \
		/opt/homebrew/lib/QtCore.framework/Headers/qabstractitemmodel.h \
		Tree/AVLTree.hpp \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include '/Users/oksanafedorova/Downloads/Telegram Desktop/aviasales/moc_predefs.h' -I/opt/homebrew/share/qt/mkspecs/macx-clang -I'/Users/oksanafedorova/Downloads/Telegram Desktop/aviasales' -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib Models/avltreemodel.h -o moc_avltreemodel.cpp

moc_formpassanger.cpp: FormPassanger/formpassanger.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include '/Users/oksanafedorova/Downloads/Telegram Desktop/aviasales/moc_predefs.h' -I/opt/homebrew/share/qt/mkspecs/macx-clang -I'/Users/oksanafedorova/Downloads/Telegram Desktop/aviasales' -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib FormPassanger/formpassanger.h -o moc_formpassanger.cpp

moc_formsales.cpp: FormSales/formsales.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include '/Users/oksanafedorova/Downloads/Telegram Desktop/aviasales/moc_predefs.h' -I/opt/homebrew/share/qt/mkspecs/macx-clang -I'/Users/oksanafedorova/Downloads/Telegram Desktop/aviasales' -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib FormSales/formsales.h -o moc_formsales.cpp

moc_hashtablemodel.cpp: Models/hashtablemodel.h \
		Models/QTableModel.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QAbstractListModel \
		/opt/homebrew/lib/QtCore.framework/Headers/qabstractitemmodel.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include '/Users/oksanafedorova/Downloads/Telegram Desktop/aviasales/moc_predefs.h' -I/opt/homebrew/share/qt/mkspecs/macx-clang -I'/Users/oksanafedorova/Downloads/Telegram Desktop/aviasales' -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib Models/hashtablemodel.h -o moc_hashtablemodel.cpp
...
moc_listmodel.cpp: Models/listmodel.h \
		...
		moc_predefs.h \
		/opt/homebrew/share/qt/libexec/moc
	/opt/homebrew/share/qt/libexec/moc $(DEFINES) --include '/Users/oksanafedorova/Downloads/Telegram Desktop/aviasales/moc_predefs.h' -I/opt/homebrew/share/qt/mkspecs/macx-clang -I'/Users/oksanafedorova/Downloads/Telegram Desktop/aviasales' -I/opt/homebrew/lib/QtWidgets.framework/Headers -I/opt/homebrew/lib/QtGui.framework/Headers -I/opt/homebrew/lib/QtCore.framework/Headers -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/c++/v1 -I/Library/Developer/CommandLineTools/usr/lib/clang/15.0.0/include -I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include -I/Library/Developer/CommandLineTools/usr/include -F/opt/homebrew/lib Models/listmodel.h -o moc_listmodel.cpp
...
compiler_uic_make_all: ui_formflight.h ui_formpassanger.h ui_formsales.h ui_mainwindow.h
compiler_uic_clean:
	-$(DEL_FILE) ui_formflight.h ui_formpassanger.h ui_formsales.h ui_mainwindow.h
ui_formflight.h: FormFlight/formflight.ui \
		/opt/homebrew/share/qt/libexec/uic
	/opt/homebrew/share/qt/libexec/uic FormFlight/formflight.ui -o ui_formflight.h

ui_formpassanger.h: FormPassanger/formpassanger.ui \
		/opt/homebrew/share/qt/libexec/uic
	/opt/homebrew/share/qt/libexec/uic FormPassanger/formpassanger.ui -o ui_formpassanger.h

ui_formsales.h: FormSales/formsales.ui \
		/opt/homebrew/share/qt/libexec/uic
	/opt/homebrew/share/qt/libexec/uic FormSales/formsales.ui -o ui_formsales.h
...
Flight.o: Flight/Flight.cpp Flight/Flight.hpp \
		/opt/homebrew/lib/QtCore.framework/Headers/QStringList \
		/opt/homebrew/lib/QtCore.framework/Headers/qstringlist.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Flight.o Flight/Flight.cpp

formflight.o: FormFlight/formflight.cpp FormFlight/formflight.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		ui_formflight.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o formflight.o FormFlight/formflight.cpp

HashTable.o: HashTable/HashTable.cpp HashTable/HashTable.hpp \
		Passenger/Passenger.hpp \
		/opt/homebrew/lib/QtCore.framework/Headers/QStringList \
		/opt/homebrew/lib/QtCore.framework/Headers/qstringlist.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o HashTable.o HashTable/HashTable.cpp
...
Passenger.o: Passenger/Passenger.cpp Passenger/Passenger.hpp \
		/opt/homebrew/lib/QtCore.framework/Headers/QStringList \
		/opt/homebrew/lib/QtCore.framework/Headers/qstringlist.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Passenger.o Passenger/Passenger.cpp
...
AVLTree.o: Tree/AVLTree.cpp Tree/AVLTree.hpp \
		Flight/Flight.hpp \
		/opt/homebrew/lib/QtCore.framework/Headers/QStringList \
		/opt/homebrew/lib/QtCore.framework/Headers/qstringlist.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o AVLTree.o Tree/AVLTree.cpp

QTableModel.o: Models/QTableModel.cpp Models/QTableModel.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QAbstractListModel \
		/opt/homebrew/lib/QtCore.framework/Headers/qabstractitemmodel.h \
...
avltreemodel.o: Models/avltreemodel.cpp Models/avltreemodel.h \
		Models/QTableModel.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QAbstractListModel \
		/opt/homebrew/lib/QtCore.framework/Headers/qabstractitemmodel.h \
		Tree/AVLTree.hpp \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QStringList \
		/opt/homebrew/lib/QtCore.framework/Headers/qstringlist.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o avltreemodel.o Models/avltreemodel.cpp

formpassanger.o: FormPassanger/formpassanger.cpp FormPassanger/formpassanger.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		ui_formpassanger.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o formpassanger.o FormPassanger/formpassanger.cpp

formsales.o: FormSales/formsales.cpp FormSales/formsales.h \
		/opt/homebrew/lib/QtWidgets.framework/Headers/QWidget \
		/opt/homebrew/lib/QtWidgets.framework/Headers/qwidget.h \
		...
		ui_formsales.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o formsales.o FormSales/formsales.cpp

hashtablemodel.o: Models/hashtablemodel.cpp Models/hashtablemodel.h \
		Models/QTableModel.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QAbstractListModel \
		/opt/homebrew/lib/QtCore.framework/Headers/qabstractitemmodel.h \
		/opt/homebrew/lib/QtCore.framework/Headers/qobject.h \
		...
		/opt/homebrew/lib/QtCore.framework/Headers/QStringList \
		/opt/homebrew/lib/QtCore.framework/Headers/qstringlist.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o hashtablemodel.o Models/hashtablemodel.cpp
...
moc_formflight.o: moc_formflight.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_formflight.o moc_formflight.cpp

moc_QTableModel.o: moc_QTableModel.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_QTableModel.o moc_QTableModel.cpp

moc_avltreemodel.o: moc_avltreemodel.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_avltreemodel.o moc_avltreemodel.cpp

moc_formpassanger.o: moc_formpassanger.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_formpassanger.o moc_formpassanger.cpp

moc_formsales.o: moc_formsales.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_formsales.o moc_formsales.cpp

moc_hashtablemodel.o: moc_hashtablemodel.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_hashtablemodel.o moc_hashtablemodel.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/aviasales/bin || mkdir -p $(INSTALL_ROOT)/opt/aviasales/bin
	$(DEL_FILE) -r $(INSTALL_ROOT)/opt/aviasales/bin/aviasales.app
	
	$(QINSTALL) aviasales.app $(INSTALL_ROOT)/opt/aviasales/bin/aviasales.app
	-$(STRIP) $(INSTALL_ROOT)/opt/aviasales/bin/aviasales.app/Contents/MacOS/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/aviasales/bin/aviasales.app
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/aviasales/bin/ 
